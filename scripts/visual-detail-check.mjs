...
const routes = ['index.html', 'tracks.html', 'register.html', 'prizes.html', 'ethics.html', 'rules.html', 'leaderboard.html', 'organizers.html', 'participant-guide.html', 'track-record.html', '404.html'];
...
function assertState(state, route, width) {
  ...
  if (state.brandText !== 'EEG/EMG Foundation Challenge 2026' || state.seal !== null) throw new Error(`text-only masthead inputs ${route} ${width}: ${JSON.stringify({brandText:state.brandText,seal:state.seal})}`);
