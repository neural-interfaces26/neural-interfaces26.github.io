...
def check_typography(errors: list[str]) -> None:
    ...
    rules = (
        ...
        ("assets/css/organizers.css", "organizer mobile cadence", r"@media\s*\(max-width:\s*768px\)\s*\{[^}]*\.org-section\s*\{[^}]*padding-block\s*:\s*64px[^}]*\}[^}]*\.org-section-head\s*\{[^}]*margin-bottom\s*:\s*36px"),
