...
def check_typography(errors: list[str]) -> None:
    ...
    rules = (
        ...
        ("assets/css/landing.css", "track heading scale", r"\.track-card h3\s*\{[^}]*font-size\s*:\s*clamp\(24px,\s*2vw,\s*30px\)[^}]*font-weight\s*:\s*700[^}]*line-height\s*:\s*1\.25"),
        ("assets/css/landing.css", "homepage sponsor heading scale", r"\.sponsor-wall-intro h2\s*\{[^}]*font-size\s*:\s*var\(--bs-type-section\)"),
        ...
        ("assets/css/landing.css", "award feature heading scale", r"\.award-breakdown \.vb-track h3\s*\{[^}]*font-size\s*:\s*clamp\(24px,\s*3vw,\s*30px\)"),
        ...
        ("assets/css/landing.css", "secondary desktop cadence", r"@media\s*\(min-width:\s*769px\)\s*\{[^}]*\.technical-page \.vb-section,[^{]*\.narrative-page \.year-entry > \.vb-section\s*\{[^}]*padding-block\s*:\s*80px"),
        ("assets/css/landing.css", "secondary mobile cadence", r"@media\s*\(max-width:\s*768px\)\s*\{[^}]*\.technical-page \.vb-section,[^{]*\.narrative-page \.year-entry > \.vb-section\s*\{[^}]*padding-block\s*:\s*(?:56|64)px"),
        ("assets/css/landing.css", "secondary mobile heading groups", r"@media\s*\(max-width:\s*768px\)\s*\{[^}]*\.technical-page \.vb-section-head,[^{]*\.narrative-page \.vb-section-head\s*\{[^}]*margin-bottom\s*:\s*36px"),
        ...
        ("assets/css/organizers.css", "organizer section scale", r"\.org-section\s*\{[^}]*padding\s*:\s*80px[^}]*\}.*?\.org-section-head\s*\{[^}]*margin-bottom\s*:\s*48px[^}]*\}.*?\.org-section-head h2\s*\{[^}]*font-size\s*:\s*var\(--bs-type-section\)[^}]*font-weight\s*:\s*var\(--bs-weight-display\)[^}]*line-height\s*:\s*1\.1"),
        ...
        ("assets/css/organizers.css", "organizer mobile cadence", r"@media\s*\(max-width:\s*640px\)\s*\{[^}]*\.org-section\s*\{[^}]*padding-block\s*:\s*64px[^}]*\}[^}]*\.org-section-head\s*\{[^}]*margin-bottom\s*:\s*36px"),
    )
